...
object ConsumerGroupEncryptedMessages extends App {

    var logger: Logger = LoggerFactory.getLogger(ConsumerGroupRawMessages.getClass.getName())

    val bootstrapServers: String = "127.0.01:9092"
    val groupId: String = "encrypted-messages-application"
    val topic: String = "encrypted_messages"
